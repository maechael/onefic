 ...
 */
class m220523_004304_create_equipment_maintenance_log_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->createIndex(
            '{{%idx-equipment_maintenance_log-fic_equipment_id}}',
            '{{%equipment_maintenance_log}}',
            'fic_equipment_id'
        );

        $this->addForeignKey(
            '{{%fk-equipment_maintenance_log-fic_equipment_id}}',
            '{{%equipment_maintenance_log}}',
            'fic_equipment_id',
            '{{%fic_equipment}}',
            'id',
