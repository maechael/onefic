 ...
 */
class m230109_004137_create_maintenance_checklist_log_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    public function safeDown()
    {
        ...
        try {
            if ($tableSchema = $this->db->getTableSchema('{{%maintenance_checklist_log}}')) {
                ...
                $indexes = $this->db->createCommand("SHOW INDEXES FROM `maintenance_checklist_log` WHERE `Key_name` = 'idx-maintenance_checklist_log-fic_equipment_id'")->queryAll();
