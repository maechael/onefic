...
// $('.dynamicform_wrapper_component').on('fileclear', (e) => {
//   wizard.smartWizard('fixHeight');
// });

// $('.dynamicform_wrapper_component').on('filebatchselected', (e) => {
//   wizard.smartWizard('fixHeight');
// });

// $('.dynamicform_wrapper_component').on('filecleared', function (event) {
//   wizard.smartWizard('fixHeight');
// });

// $('.dynamicform_wrapper_component').on('filepredelete', (jqXHR) => {
//   let abort = true;
