...
$this->title = '';
$this->params['breadcrumbs'][] = 'User Profiles';
?>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $key, $index, $widget) {
                    ...
                    return Html::a($display, ['user-profile/toggle-status', 'id' => $model->id], ['data-method' => 'post', 'class' => 'btn btn-outline-primary btn-sm btn-block status-toggle']);
                },
