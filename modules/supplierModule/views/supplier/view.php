...
<?= DetailView::widget([
    ...
    'attributes' => [
        ...
        [
            'columns' => [
                ['attribute' => 'organization_name', 'valueColOptions' => ['style' => 'width:30%']],
                ['attribute' => 'organization_status', 'value' => $model->getOrganizationStatus(), 'valueColOptions' => ['style' => 'width:30%']],
            ]
        ],
        [
            'columns' => [
...
<?php if ($model->getBranches()->count() > 0) : ?>
    <div class="card">
        <div class="card-header text-white bg-primary">
            <h5 class="card-title mb-0"><i class='fas fa-box'></i> Branches</h5>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-toggle="collapse" data-target="#branchCollapse" aria-expanded="true" aria-controls="branchCollapse">
                    <i class="fas fa-minus"></i>
                </button>
            </div>
        </div>
        <div id="branchCollapse" class="collapse show">
            <div class="card-body">
                <?php if ($model->getBranches()->count() == 0) : ?>
...
<?php if ($model->getParts()->count() > 0) : ?>
    <div class="card">
        <div class="card-header text-white bg-primary">
            <h5 class="card-title">Part Availability</i>'</h5>
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-toggle="collapse" data-target="#partCollapse" aria-expanded="true" aria-controls="partCollapse">
                    <i class="fas fa-minus"></i>
                </button>
            </div>
        </div>
        <div id="partCollapse" class="collapse show">
            <div class="card-body">
                <div class="card-columns">
