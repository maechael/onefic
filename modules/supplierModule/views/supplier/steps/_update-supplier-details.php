...
<div class="card">
    ...
    <div class="card-body">
        ...
        if (!$supplier->isNewRecord) {
            echo Html::activeHiddenInput($supplier, "id");
        } ?>
        <div class="d-flex">
            <div class="flex-fill">
            ...
            <div class="flex-fill">
                <?= $form->field($supplier, 'is_philgeps_registered')->widget(CheckboxX::class, [
                    ...
                    'pluginEvents' => [
                        ...
                        // "checkbox:resetinput" => "function() { console.log('reset'); }",
                        "change" => <<<JS
                                function(e){
                                    if(e.target.value == 1){
        ...
        <div class="d-flex">
            ...
            <div class="pl-2 flex-fill">
                <?= $form->field($supplier, 'province_id')->widget(DepDrop::class, [
                    'bsVersion' => '4.x',
                    'data' => [$supplier->province_id => $supplier->province->name],
                    ...
                    'pluginOptions' => [
                        ...
                        'initDepends' => ['supplier-region_id'],
                        'placeholder' => 'Select a province...',
            ...
            <div class="pl-2 flex-fill">
                <?= $form->field($supplier, 'municipality_city_id')->widget(DepDrop::class, [
                    'data' => [$supplier->municipality_city_id => $supplier->municipalityCity->name],
                    'type' => DepDrop::TYPE_SELECT2,
                    'select2Options' => [
                        // 'size' => Select2::SMALL,
                        'pluginOptions' => [
                    ...
                    'pluginOptions' => [
                        ...
                        'initDepends' => ['supplier-region_id', 'supplier-province_id'],
                        'placeholder' => 'Select a municipality...',
