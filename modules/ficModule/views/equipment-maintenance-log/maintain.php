...
$this->title = "{$ficEquipment->equipment->model} Preventive Maintenance Sheet";
$this->params['breadcrumbs'][] = ['label' => 'Fic Equipments', 'url' => Url::to('/fic-module/fic-equipment/index')];
$this->params['breadcrumbs'][] = ['label' => $ficEquipment->equipment->model, 'url' => Url::to(['/fic-module/fic-equipment/view', 'id' => $ficEquipment->id])];
