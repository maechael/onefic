...
/**
 * ComponentTwoController implements the CRUD actions for Component model.
 */
class ComponentTwoController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Component",
                    'content' => '<span class="text-success">Create Component success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Component model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Component model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
