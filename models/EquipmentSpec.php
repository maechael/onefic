...
class EquipmentSpec extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['spec_key_id'], 'exist', 'skipOnError' => true, 'targetClass' => SpecKey::className(), 'targetAttribute' => ['spec_key_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(SpecKey::className(), ['id' => 'spec_key_id']);
    }
}
