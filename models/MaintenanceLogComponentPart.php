...
class MaintenanceLogComponentPart extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['isOperational'], 'default', 'value' => self::IS_OPERATIONAL_YES],
            [['isInspected'], 'default', 'value' => self::IS_INSPECTED_YES],
            ...
            [['equipment_component_part_id'], 'exist', 'skipOnError' => true, 'targetClass' => EquipmentComponentPart::className(), 'targetAttribute' => ['equipment_component_part_id' => 'id']],
            [['equipment_maintenance_log_id'], 'exist', 'skipOnError' => true, 'targetClass' => EquipmentMaintenanceLog::className(), 'targetAttribute' => ['equipment_maintenance_log_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(EquipmentComponentPart::className(), ['id' => 'equipment_component_part_id']);
    }
    ...
    {
        return $this->hasOne(EquipmentMaintenanceLog::className(), ['id' => 'equipment_maintenance_log_id']);
    }

    public function getPart()
    {
        return $this->hasOne(Part::class, ['id' => 'part_id'])->via('equipmentComponentPart');
    }
