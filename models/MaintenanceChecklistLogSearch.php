...
class MaintenanceChecklistLogSearch extends MaintenanceChecklistLog
{
    ...
    public function rules()
    {
        return [
            ...
            [['global_id', 'accomplished_by_name', 'accomplished_by_designation', 'accomplished_by_office', 'accomplished_by_date', 'endorsed_by_name', 'endorsed_by_designation', 'endorsed_by_office', 'endorsed_by_date', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'global_id', $this->global_id])
            ->andFilterWhere(['like', 'accomplished_by_name', $this->accomplished_by_name])
